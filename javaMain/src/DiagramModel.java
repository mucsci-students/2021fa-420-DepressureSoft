...
public class DiagramModel {
    ...
    */
    ...
    public boolean addRelationship(String from, String to) {
        return false; // temporary return statement
    }

    // this method also checks existence of classes
    public boolean deleteRelationship(String from, String to) {
        return false; // temporary return statement
    }

    // this method also checks existence of class and validity of attName
    public boolean addAttribute(String className, String attName) {
        return false; // temporary return statement
    }

    // this method also checks existence of class and attribute
    public boolean deleteAttribute(String className, String attName) {
        return false; // temporary return statement
    }
